...
#	@kiritosshxd
#====================================================
_lvk=$(wget -qO- https://raw.githubusercontent.com/sansoe2022/VPN_SCRIPT/refs/heads/main/Sistema/versao)
...
for _arq in ${_mdls[@]}; do
	...
	wget -c -P $_dir1 https://raw.githubusercontent.com/sansoe2022/VPN_SCRIPT/refs/heads/main/Modulos/$_arq
	chmod +x $_dir1/$_arq
done
...
wget https://github.com/sansoe2022/VPN_SCRIPT/raw/refs/heads/main/Install/jq-linux64 >/dev/null 2>&1
