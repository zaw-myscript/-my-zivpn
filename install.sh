...
if  "$resp" = 's' ; then
    ...
    if [ -e "/etc/SSHPlus/Token.txt" ]; then
        ...
        tput sgr0
        echo ""
        echo -ne "\033[1;32mPassword has not been registered yet, press enter to register: \033[1;37m "
        read i
        clear
        tput setaf 7
        tput setab 4
        ...
        tput sgr0
        echo ""
        echo -ne "\033[1;32menter a password: \033[1;37m "
        read senha
         -z $senha  && {
        ...
        echo -ne "\033[1;32mRegistration completed successfully✅\033[1;37m "
        echo ""
        sleep 2
        fun_usertoken
    ...
    tput sgr0
    echo ""
    echo -ne "\033[1;32mEnter username:\033[1;37m "
    read username
     -z $username  && {
     ...
     "$(grep -wc $username /etc/passwd)" != '0'  && {
        echo -e "\n${cor1}This user already exists.Try another${scor}\n"
        exit 1
    }
     ${username} != ?(+|-)+([a-zA-Z0-9])  && {
    ...
    sizemin=$(echo ${#username})
     $sizemin -lt 2  && {
        echo -e "\n${cor1}You entered a username${scor}"
    ...
    sizepass=$(echo ${#password})
     $sizepass -lt 4  && {
        echo -e "\n${cor1}Short password!, use at least 4${scor}\n"
        exit 1
    }
    echo -ne "\033[1;32mValid days:\033[1;37m "
    read dias
     -z $dias  && {
        echo -e "\n${cor1}Empty number of days!${scor}\n"
        exit 1
    }
     ${dias} != ?(+|-)+([0-9])  && {
        echo -e "\n${cor1}You entered a number of days${scor}\n"
        exit 1
    }
     $dias -lt 1  && {
        echo -e "\n${cor1}The number must be greater than 0!${scor}\n"
        exit 1
    }
    echo -ne "\033[1;32mConnection limit:\033[1;37m "
    read sshlimiter
     -z $sshlimiter  && {
        echo -e "\n${cor1}You have exceeded the connection limit${scor}\n"
        exit 1
    }
     ${sshlimiter} != ?(+|-)+([0-9])  && {
     ...
     -e /etc/openvpn/server.conf  && {
        ...
        read resp
         "$resp" = @(s|S)  && {
            ...
            read respost
            echo -ne "\033[1;32mHost Atual\033[1;37m: \033[1;31m(\033[1;37m$Host\033[1;31m) \033[1;37m- \033[1;32mAlterar \033[1;31m? \033[1;33m[s/n]:\033[1;37m "
            read oprc
             "$oprc" = @(s|S)  && {
                fun_edithost
            } || {
             ...
             -d /var/www/html/openvpn  && {
                mv $HOME/$username.zip /var/www/html/openvpn/$username.zip >/dev/null 2>&1
                 "$VERSION_ID" = 'VERSION_ID="14.04"'  && {
                    echo -e "\033[1;32mOVPN LINK\033[1;37m: \033[1;36m$IP:81/html/openvpn/$username.zip"
                } || {
                    echo -e "\033[1;32mOVPN LINK\033[1;37m: \033[1;36m$IP:81/openvpn/$username.zip"
                }
            } || {
            ...
            clear
            echo -e "\E[44;1;37m       SSH ACCOUNT CRE !      \E[0m"
            echo -e "\n\033[1;32mIP: \033[1;37m$IP"
            echo -e "\033[1;32mUsername: \033[1;37m$username"
            echo -e "\033[1;32mPassword: \033[1;37m$password"
            echo -e "\033[1;32mExpiry date: \033[1;37m$gui"
